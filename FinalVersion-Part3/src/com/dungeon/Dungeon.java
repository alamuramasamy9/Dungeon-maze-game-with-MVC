...
public interface Dungeon {
  ...
  ArrayList<Node> identifyTunnel(ArrayList<Path> finalDungeon, int rows, int cols);
  ...
  ArrayList<Node> identifyCaves(ArrayList<Path> finalDungeon, ArrayList<Node> tunnels);
  ...
  void shuffleCaves(ArrayList<Node> caves);
}

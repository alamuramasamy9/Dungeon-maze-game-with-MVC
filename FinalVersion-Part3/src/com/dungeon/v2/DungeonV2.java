...
public class DungeonV2 {
  ...
  private int numberOfCavesTreasureAllocated;
  private ArrayList<Node> caves;
  private ArrayList<Treasure> treasureMaster;
  private ArrayList<Path> finalDungeon;
  private ArrayList<Node> tunnels;

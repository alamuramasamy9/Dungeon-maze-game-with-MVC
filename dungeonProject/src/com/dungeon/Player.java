...
public class Player implements PlayerInterface {
  ...
  @Override
  public Treasure getTreasureDetailsOfCave(
          ArrayList<HashMap<Node, Treasure>> treasureCaves, Node cave) {
  ...
  @Override
  public TreasureCollected checkPlayerCaveHasTreasure(
   ...
   * @return return possible locations
   */

  @Override
  public PlayerLocations getPossibleMoves(
          int rows, int cols, ArrayList<Path> finalDungeon, Node playerAt, boolean wrapping) {
    ...
    return new PlayerLocations(
            canMoveWest, canMoveNorth, canMoveEast, canMoveSouth, west, north, east, south);
  }
